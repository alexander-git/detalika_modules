...
use detalika\clients\forms\CardTypeForm;
use yii\filters\AccessControl;


class CardTypeController extends CrudController
{
    public function behaviors()
    {
        $mainPageTitle = 'Главная';
        $indexPageTitle = 'Типы скидочных карт';
        $pages = [
            [
        ...
        return array_merge([
            'index' => [
                ...
                'adapter' => [
                    ...
                    'model' => CardTypeForm::className(),
                    'view' => [
                        'class' => DynaGridViewRenderer::className(),
                        'title' => 'Типы скидочных карт',
                        'modelClass' => CardTypeForm::className(),
                    ],                    
                ],
            ],
            'update' => [
